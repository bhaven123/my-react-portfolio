...
const Work = () => {
  return (
    <Container id="work" className="min-vh-100">
      <h1
        className="w-25 text-center border-3 border-bottom border-secondary border-end mb-5 pb-3 fs-1 fw-bolder fw-bolder mx-auto"
        style={{ color: "#ccd6f6" }}
      >
                  ...
                  <Accordion.Body>
                    <ul>
                      <li>
                        ...
                        deeper insights into applications of Generalized
              ...
              <Accordion flush>
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    <ul>
                      <li>
                        Worked with TensorFlow Keras to fine tune a pre-trained
                        VGG16 model with custom classes.
                      </li>
                      <li>
